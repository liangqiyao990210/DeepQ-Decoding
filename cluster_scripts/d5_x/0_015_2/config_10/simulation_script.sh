...
#SBATCH --mem=25G                   # Memory per cpu in MB (see also --mem) 
...
python /hpc/home/ql94/DeepQ-Decoding/cluster_scripts/d5_x/0_015/Single_Point_Continue_Training_Script.py 10
