...
#SBATCH --job-name=0.015_100          # Job name, will show up in squeue output
...
python /hpc/home/ql94/DeepQ-Decoding/cluster_scripts/d5_x/0_015_2/Single_Point_Continue_Training_Script.py 100
